...
public class doctorProfileFragment extends Fragment {
    ...
    private void itiateView() {
        mTxtViewProfilename = view.findViewById(R.id.dr_profile_name_id);
        mTxtViewProfileEmail = view.findViewById(R.id.dr_profile_email_id);
        mTxtViewProfileId = view.findViewById(R.id.dr_profile_id_id);
    }
}
